...
public class InputServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                returnData = Main.main(new String[0]);
            ...
            HashMap<String, ArrayList<Location>> batchData2 = new HashMap<>();
            ArrayList<PickItem> a = new ArrayList<>();
            PickItem pi = new PickItem("A","12",1);
            a.add(pi);
            ArrayList<Location> b = new ArrayList<>();
            Location l = new Location("12", a);
            b.add(l);
            batchData.put("10",b);
            returnData.put("1",batchData);
            returnData.put("5",batchData);
            
            PickItem pib = new PickItem("B","98",1);
            a.add(pib);
            Location lb = new Location("98", a);
            b.add(lb);
            batchData2.put("20", b); 
            returnData.put("2",batchData2);
            returnData.put("3",batchData2);
            */
